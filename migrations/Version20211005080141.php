 ...
 */
final class Version20211005080141 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE meet (id INT AUTO_INCREMENT NOT NULL, adherent_woman_id INT NOT NULL, adherent_man_id INT NOT NULL, status_meet_woman_id INT DEFAULT NULL, status_meet_man_id INT DEFAULT NULL, started_at DATE NOT NULL, return_at_woman DATE DEFAULT NULL, return_at_man DATE DEFAULT NULL, comments_woman LONGTEXT DEFAULT NULL, comments_man LONGTEXT DEFAULT NULL, INDEX IDX_E9F6D3CEE60D7A92 (adherent_woman_id), INDEX IDX_E9F6D3CEF701299A (adherent_man_id), INDEX IDX_E9F6D3CE21F25DFE (status_meet_woman_id), INDEX IDX_E9F6D3CE7A61CCA2 (status_meet_man_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
